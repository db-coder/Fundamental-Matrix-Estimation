...
% Your code here
%%%%%%%%%%%%%%%%
A = zeros(2*size(Points_2D,1),11);
Y = zeros(2*size(Points_2D,1),1);
for i = 1:size(Points_2D,1)
	A(2*i-1,:) = [Points_3D(i,1) Points_3D(i,2) Points_3D(i,3) 1 0 0 0 0 -Points_2D(i,1)*Points_3D(i,1) -Points_2D(i,1)*Points_3D(i,2) -Points_2D(i,1)*Points_3D(i,3)];
	A(2*i,:) = [0 0 0 0 Points_3D(i,1) Points_3D(i,2) Points_3D(i,3) 1 -Points_2D(i,2)*Points_3D(i,1) -Points_2D(i,2)*Points_3D(i,2) -Points_2D(i,2)*Points_3D(i,3)];
	Y(2*i-1,:) = [Points_2D(i,1)];
	Y(2*i,:) = [Points_2D(i,2)];
end
